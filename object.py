#This file's only use is to load object.ll into a string (object.ll is not found on the platform)
def getObject():
  return """; This file is mostly generated from the C code, with just a touch of cleanup
